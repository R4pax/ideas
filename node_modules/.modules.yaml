...
hoistedDependencies:
  ...
  '@vitejs/plugin-react@4.3.4(vite@6.1.0(@types/node@20.17.18))':
  ...
  ts-node-dev@2.0.0(@types/node@20.17.18)(typescript@5.7.3):
    ts-node-dev: private
  ts-node@10.9.2(@types/node@20.17.18)(typescript@5.7.3):
    ts-node: private
  tsconfig@7.0.0:
    tsconfig: private
  type-check@0.4.0:
  ...
  vary@1.1.2:
    vary: private
  vite@6.1.0(@types/node@20.17.18):
    vite: private
  webapp:
    '@ideas/webapp': private
  which@2.0.2:
    which: private
  word-wrap@1.2.5:
    word-wrap: private
...
pendingBuilds: []
prunedAt: Thu, 13 Feb 2025 19:47:45 GMT
publicHoistPattern: []
registries:
  '@yourcoach': https://npm.pkg.github.com/
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-msvc@4.34.6'
  - fsevents@2.3.3
storeDir: /home/rapax/.local/share/pnpm/store/v10
